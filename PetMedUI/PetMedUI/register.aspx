<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Bootstrap.Master" CodeBehind="register.aspx.vb" Inherits="PetMedUI.register" %>
            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image" style="background: url(&quot;assets/img/dogs/image3.jpeg&quot;);background-position: center;background-size: cover;"></div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <div class="text-center"><a class="small" href="forgot-password.aspx">Forgot Password?</a></div>
